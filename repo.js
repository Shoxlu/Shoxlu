{
	...
	"patches": {
		...
		"Fixes": "Fixes a variety of bug in touhou games (to be completed) (Only available for th9).",
		...
		"PracticeAoCF": "(Th15.5) Battle timer is infinite in all modes, as in practice mode. Requested by Day.",
